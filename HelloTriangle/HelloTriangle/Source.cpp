...
//#endif
	...
	GLFWwindow* window = glfwCreateWindow(WIDTH, HEIGHT, "Hello Triangle! - Aluno. Vitor Requena", nullptr, nullptr);
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		glUniform4f(colorLoc, 1.0f, 0.7f, 1.0f, 1.0f); //enviando cor para variável uniform inputColor
